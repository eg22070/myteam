<x-app-layout>
 ...
 Edit teams information</a>
            ...
            <h3 class="font-semibold text-l text-gray-800 leading-tight">
                ...
                <div class=" bg-white border border-sky-400 rounded-md shadow-sm sm:rounded-lg p-6 text-gray-900">
            <h2 class=" hover-underline-animation border-sky-400 rounded-md font-semibold text-xl text-gray-800 leading-tight"><a href="{{route('comment', ['teamslug' => $teams->vecums]) }}"><u>View coach comments</u></a></h2>
